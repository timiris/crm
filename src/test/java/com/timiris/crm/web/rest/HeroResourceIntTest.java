...
public class HeroResourceIntTest {
    ...
    private static final String DEFAULT_ALTER_EGO = "AAAAAAAAAA";
    private static final String UPDATED_ALTER_EGO = "BBBBBBBBBB";
    ...
    public void setup() {
        ...
        HeroResource heroResource = new HeroResource(heroService);
    ...
    public void createHero() throws Exception {
        ...
        assertThat(testHero.getAlterEgo()).isEqualTo(DEFAULT_ALTER_EGO);
    }
    ...
    public void getAllHeroes() throws Exception {
        ...
        restHeroMockMvc.perform(get("/api/heroes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].alterEgo").value(hasItem(DEFAULT_ALTER_EGO.toString())));
    }
    ...
    public void getHero() throws Exception {
        ...
        restHeroMockMvc.perform(get("/api/heroes/{id}", hero.getId()))
            ...
            .andExpect(jsonPath("$.alterEgo").value(DEFAULT_ALTER_EGO.toString()));
    }
    ...
    public void updateHero() throws Exception {
        ...
        assertThat(testHero.getAlterEgo()).isEqualTo(UPDATED_ALTER_EGO);
    }
